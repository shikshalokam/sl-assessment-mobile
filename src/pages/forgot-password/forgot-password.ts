...
export class ForgotPasswordPage {
  ...
  getPassword() {
    ...
    this.http.post(AppConfigs.punjabBaseUrl + AppConfigs.punjab.forgotPassword, params, httpOptions).subscribe(
      (success) => {},
      (error) => {
  ...
  forgetPassword() {
    ...
    let url = AppConfigs.user_management_base_url + "v1" + AppConfigs.punjab.forgotPasswordNew;
